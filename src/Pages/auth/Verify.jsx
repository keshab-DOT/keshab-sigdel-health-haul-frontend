  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <nav className="flex justify-between items-center px-4 sm:px-8 py-4 sm:py-5 shadow-md bg-white">
        ...
        <Link to="/login" className="hover:text-green-600 font-medium transition text-sm sm:text-base">Login</Link>
      </nav>
        ...
        <div className="flex bg-white shadow-2xl rounded-2xl overflow-hidden w-full max-w-5xl">
          ...
          <div className="hidden md:block w-1/2 relative bg-gradient-to-br from-green-500 to-green-700">
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white z-10">
              <h2 className="text-3xl lg:text-4xl font-bold mb-3">Verify Your Email</h2>
              <p className="text-base lg:text-lg text-gray-200">Enter the OTP sent to your email to activate your account</p>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 p-6 sm:p-8 lg:p-12">
            <div className="mb-6 sm:mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold mb-2 text-gray-800">Email Verification</h2>
              <p className="text-gray-600 text-sm sm:text-base">
                We sent a 4-digit OTP to{" "}
                <span className="font-semibold text-green-600 break-all">{email || "your email"}</span>
              </p>
            </div>

            <form onSubmit={verify} className="space-y-4 sm:space-y-5">
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Enter OTP</label>
                <input
                  type="text" placeholder="Enter 4-digit OTP" value={code}
                  onChange={(e) => setCode(e.target.value)} maxLength={4} required
                  className="border border-gray-300 p-3 sm:p-4 w-full rounded-lg text-center tracking-[0.5em] text-xl sm:text-2xl font-bold focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition"
                />
              </div>
              ...
              <div className="text-center">
                <p className="text-gray-600 text-xs sm:text-sm">
                  ...
                  <button
                    type="button" onClick={resendOTP} disabled={resending}
            ...
            <div className="mt-5 sm:mt-6 text-center">
              <Link to="/signup" className="text-gray-500 hover:text-green-600 text-xs sm:text-sm transition">
                ← Back to Signup
              </Link>
            </div>
          </div>
