...
function ProductCard({ product, onAddToCart, adding, onReviewClick, pharmacyRatings }) {
  ...
  const src = product.productImageUrl ? (product.productImageUrl.startsWith("http") ? product.productImageUrl : `http://localhost:3000/uploads/${product.productImageUrl}`) : null;
  return (
