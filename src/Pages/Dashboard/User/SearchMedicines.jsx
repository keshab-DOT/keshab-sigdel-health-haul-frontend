...
function ProductCard({ product, onAddToCart, adding, onReviewClick, pharmacyRatings }) {
  ...
  const src = product.productImageUrl ? (product.productImageUrl.startsWith("http") ? product.productImageUrl : `http://keshab-sigdel-health-haul-backend-production.up.railway.app/uploads/${product.productImageUrl}`) : null;
  return (
