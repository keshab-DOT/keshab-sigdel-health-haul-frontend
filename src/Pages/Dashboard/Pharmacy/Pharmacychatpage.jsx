    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <span className="flex-shrink-0 opacity-50 relative">
          ...
          {unread > 0 && (
            <span
              className="absolute -top-1.5 -right-1.5 min-w-[14px] h-[14px] bg-red-500 text-white
...
function MobileTopbar({ onMenuOpen }) {
  return (
    <div
      className="lg:hidden fixed top-0 inset-x-0 z-20 bg-white border-b border-gray-100
...
function Avatar({ name, role, size = "md", online = false }) {
  ...
  return (
    <div className="relative flex-shrink-0">
      <div
        className={`${sizes[size]} rounded-full bg-gradient-to-br ${gradient} flex items-center justify-center text-white font-black`}
      >
        {name?.[0]?.toUpperCase() || "?"}
      </div>
      {online && (
...
function RoleBadge({ roles }) {
  ...
  if (role === "admin") {
    return (
      <span className="text-[9px] font-bold text-gray-100 bg-gray-800 px-1.5 py-0.5 rounded-full flex-shrink-0">
        Admin
      </span>
    );
  }
  return (
    <span className="text-[9px] font-bold text-blue-600 bg-blue-100 px-1.5 py-0.5 rounded-full flex-shrink-0">
      User
    </span>
  );
}
...
function MessageBubble({ msg, isMine, onDelete }) {
  ...
  return (
    ...
    >
      <div
        className={`max-w-[75%] sm:max-w-[70%] flex flex-col gap-1 ${isMine ? "items-end" : "items-start"}`}
      >
        {msg.image && (
          <div
...
export default function PharmacyChatPage() {
  ...
  const getUserRole = (roles) =>
    (Array.isArray(roles) ? roles[0] : roles || "").toLowerCase();
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p
                    className={`text-[11px] truncate ${hasUnread ? "text-gray-700 font-semibold" : "text-gray-400"}`}
                  >
      ...
      <div className="px-4 sm:px-5 py-3.5 border-b border-gray-100 flex items-center gap-3 bg-white flex-shrink-0">
        ...
        {selected && (
          <>
            <Avatar
              name={selected.name}
              role={getUserRole(selected.roles)}
              size="md"
        ...
        {!selected ? (
          <div className="flex flex-col items-center justify-center h-full text-center p-8">
            ...
            <p className="text-[13px] text-gray-400 max-w-xs">
              Choose a customer or admin from the list to view and reply to
              their messages.
            </p>
          </div>
        ) : loadingMsgs ? (
  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa]">
      ...
      {toast && (
        <div
          className={`fixed top-5 right-4 left-4 sm:left-auto sm:w-auto z-[9999] flex items-center gap-2.5
      ...
      <div
        className="lg:pl-[200px] pt-14 lg:pt-0 flex flex-col"
        style={{ height: "100dvh" }}
      >
            ...
            <div className="hidden lg:flex w-full">
              ...
              {!selected ? (
                <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
                  ...
                  <p className="text-[13px] text-gray-400 max-w-xs">
                    Choose a customer or admin from the list to view and reply
                    to their messages.
                  </p>
                </div>
              ) : (
