  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa]">
      ...
      <div className="lg:pl-[200px] pt-[52px] lg:pt-0">
        <main className="px-4 sm:px-8 py-7 min-h-screen max-w-4xl">
          <div className="mb-7">
            ...
            <p className="text-gray-400 text-[13px] mt-0.5">
              Manage your pharmacy account information
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-6 mb-5">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
              <div className="relative flex-shrink-0">
                <div className="w-16 sm:w-20 h-16 sm:h-20 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white font-black text-xl sm:text-2xl shadow-md">
                  {initials}
                </div>
              ...
              <div className="flex-1 min-w-0">
                <h2 className="text-[18px] sm:text-[20px] font-black text-gray-900 leading-tight truncate">
                  {profile.name || "Pharmacy Name"}
                </h2>
              ...
              <div className="flex-shrink-0 flex flex-row sm:flex-col gap-2 w-full sm:w-auto">
                <button
                  ...
                  className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-gray-950 text-white px-4 py-2 rounded-xl font-bold text-[12px] hover:bg-gray-800 transition"
                >
                  <svg
                ...
                <button
                  ...
                  className="flex-1 sm:flex-none flex items-center justify-center gap-2 border border-gray-200 text-gray-600 px-4 py-2 rounded-xl font-bold text-[12px] hover:border-green-300 hover:text-green-700 transition"
                >
                  <svg
                    className="w-3.5 h-3.5"
                    fill="none"
          ...
          <div className="flex gap-1 bg-white border border-gray-100 rounded-2xl p-1.5 shadow-sm mb-5 w-fit">
            {TABS.map((t) => (
              <button
                ...
                className={`px-4 sm:px-5 py-2 rounded-xl text-[13px] font-bold transition-all ${activeTab === t.key ? "bg-gray-950 text-white shadow-sm" : "text-gray-500 hover:text-gray-800"}`}
              >
                {t.label}
              </button>
            ))}
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="px-5 sm:px-6 py-4 border-b border-gray-100">
                  ...
                  <p className="text-[11px] text-gray-400 mt-0.5">
                    Update your pharmacy's public details
                  </p>
                </div>
                ...
                <div className="px-5 sm:px-6 py-4 border-t border-gray-100 bg-gray-50/40 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          {activeTab === "security" && (
            <form onSubmit={savePassword}>
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div className="p-5 sm:p-6 space-y-4 max-w-md">
                  {[
                    {
                  ...
                  {passwords.confirmPassword && (
                    <div
                      className={`flex items-center gap-2 text-[12px] font-semibold px-3.5 py-2.5 rounded-xl border ${passwords.newPassword === passwords.confirmPassword ? "bg-green-50 text-green-700 border-green-100" : "bg-red-50 text-red-600 border-red-100"}`}
                    >
          ...
          <div className="mt-5 bg-white rounded-2xl border border-red-100 shadow-sm overflow-hidden">
            <div className="px-5 sm:px-6 py-4 border-b border-red-100 flex items-center gap-2">
              <svg
              ...
              <h3 className="text-[15px] font-black text-red-700">
                Danger Zone
              </h3>
            </div>
