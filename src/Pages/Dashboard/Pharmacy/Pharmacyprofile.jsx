    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          disabled={disabled}
          className={`w-full border border-gray-200 rounded-xl py-2.5 text-[13px] focus:outline-none focus:ring-2 focus:ring-green-400/40 focus:border-green-400 transition
...
function Toast({ toast }) {
  ...
  return (
    <div className={`fixed top-5 right-5 z-50 flex items-center gap-2.5 px-4 py-3 rounded-xl shadow-lg text-white text-[13px] font-bold transition-all
...
export default function PharmacyProfile() {
  ...
  const [profile, setProfile] = useState({
    name: "", email: "", phone: "", address: "", licenseNumber: "", description: "",
  });
    ...
    <div className="min-h-screen bg-[#f7f8fa]">
      ...
      <div className="pl-[200px]">
        <main className="px-8 py-7 min-h-screen max-w-4xl">
          ...
          {/* Page header */}
          <div className="mb-7">
            <h1 className="text-[26px] font-black text-gray-900 tracking-tight leading-tight">Pharmacy Profile</h1>
            <p className="text-gray-400 text-[13px] mt-0.5">Manage your pharmacy account information</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-5">
            <div className="flex items-center gap-5">
              <div className="relative flex-shrink-0">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white font-black text-2xl shadow-md">
                  {initials}
                </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-2 flex-wrap">
                  <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-green-700 bg-green-50 border border-green-100 px-2.5 py-1 rounded-full">
              ...
              <div className="flex-shrink-0 flex flex-col gap-2">
                <button onClick={() => navigate("/pharmacy/orders")}
                  className="flex items-center gap-2 bg-gray-950 text-white px-4 py-2 rounded-xl font-bold text-[12px] hover:bg-gray-800 transition">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                  View Orders
                </button>
                <button onClick={() => navigate("/pharmacy/dashboard")}
                  className="flex items-center gap-2 border border-gray-200 text-gray-600 px-4 py-2 rounded-xl font-bold text-[12px] hover:border-green-300 hover:text-green-700 transition">
            ...
            {TABS.map(t => (
              <button key={t.key} onClick={() => setActiveTab(t.key)}
                className={`px-5 py-2 rounded-xl text-[13px] font-bold transition-all
                  ${activeTab === t.key ? "bg-gray-950 text-white shadow-sm" : "text-gray-500 hover:text-gray-800"}`}>
                {t.label}
              </button>
            ))}
          </div>
            ...
            <form onSubmit={saveProfile}>
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-100">
                  <h3 className="text-[15px] font-black text-gray-900">Pharmacy Information</h3>
                  <p className="text-[11px] text-gray-400 mt-0.5">Update your pharmacy's public details</p>
                </div>

                <div className="p-6 space-y-5">
                  <div className="grid grid-cols-2 gap-4">
                    <Field label="Pharmacy Name *" name="name" value={profile.name} onChange={handleProfileChange} placeholder="e.g. Sunrise Pharmacy"
                      icon={<svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>}
                    />
                    <Field label="Email Address" name="email" value={profile.email} onChange={handleProfileChange} type="email" placeholder="pharmacy@example.com"
                      icon={<svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>}
                    />
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <Field label="Phone Number" name="phone" value={profile.phone} onChange={handleProfileChange} placeholder="98XXXXXXXX"
                      icon={<svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>}
                    />
                    <Field label="License Number" name="licenseNumber" value={profile.licenseNumber} onChange={handleProfileChange} placeholder="e.g. PH-2024-XXXXX"
                      icon={<svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>}
                    />
                  </div>

                  <Field label="Pharmacy Address" name="address" value={profile.address} onChange={handleProfileChange} placeholder="Street, City, District"
                    icon={<svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>}
                  />

                  <div>
                    <label className="block text-[12px] font-bold text-gray-700 mb-1.5">About Your Pharmacy</label>
                    <textarea name="description" value={profile.description} onChange={handleProfileChange} rows={3}
                      placeholder="Briefly describe your pharmacy, specialties, or opening hours…"
                ...
                <div className="px-6 py-4 border-t border-gray-100 bg-gray-50/40 flex items-center justify-between">
                  ...
                  <button type="submit" disabled={saving}
                    className="flex items-center gap-2 bg-gray-950 text-white px-5 py-2.5 rounded-xl font-bold text-[13px] hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition">
                    {saving
          ...
          {activeTab === "security" && (
            <form onSubmit={savePassword}>
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-100">
                  <h3 className="text-[15px] font-black text-gray-900">Change Password</h3>
                  <p className="text-[11px] text-gray-400 mt-0.5">Use a strong password — at least 6 characters</p>
                </div>
                ...
                <div className="p-6 space-y-4 max-w-md">
                  {[
                    ...
                    { name: "confirmPassword",  label: "Confirm New Password", key: "confirm", placeholder: "Re-enter new password"   },
                    ...
                    <div key={name}>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder={placeholder}
                          required
                          className="w-full border border-gray-200 rounded-xl pl-10 pr-11 py-2.5 text-[13px] focus:outline-none focus:ring-2 focus:ring-green-400/40 focus:border-green-400 bg-white transition"
                        />
                  ...
                  {passwords.newPassword && (
                    <div className={`flex items-center gap-2 text-[12px] font-semibold px-3.5 py-2.5 rounded-xl border
                      ${passwords.newPassword.length >= 8 ? "bg-green-50 text-green-700 border-green-100" : "bg-amber-50 text-amber-700 border-amber-100"}`}>
                      {passwords.newPassword.length >= 8
                        ? <><svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>Strong password</>
                        : <><svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/></svg>Use 8+ characters for a stronger password</>
                      }
                    </div>
                  )}
                  ...
                  {passwords.confirmPassword && (
                    <div className={`flex items-center gap-2 text-[12px] font-semibold px-3.5 py-2.5 rounded-xl border
                      ${passwords.newPassword === passwords.confirmPassword ? "bg-green-50 text-green-700 border-green-100" : "bg-red-50 text-red-600 border-red-100"}`}>
                ...
                <div className="px-6 py-4 border-t border-gray-100 bg-gray-50/40 flex items-center justify-between">
                  ...
                  <button type="submit" disabled={saving || passwords.newPassword !== passwords.confirmPassword}
                    className="flex items-center gap-2 bg-gray-950 text-white px-5 py-2.5 rounded-xl font-bold text-[13px] hover:bg-gray-800 disabled:opacity-40 disabled:cursor-not-allowed transition">
                    {saving
          ...
          <div className="mt-5 bg-white rounded-2xl border border-red-100 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-red-100 flex items-center gap-2">
              ...
              <h3 className="text-[15px] font-black text-red-700">Danger Zone</h3>
            </div>
            <div className="px-6 py-4 flex items-center justify-between">
              <div>
                <p className="text-[13px] font-bold text-gray-800">Sign out of your account</p>
                <p className="text-[11px] text-gray-400 mt-0.5">You will be redirected to the login page</p>
              </div>
              <button
                onClick={async () => {
                  try { await api.post("/auth/logout"); } catch (_) {}
                ...
                className="flex items-center gap-2 border border-red-200 text-red-600 px-4 py-2.5 rounded-xl font-bold text-[13px] hover:bg-red-50 hover:border-red-300 transition">
