...
export default function PharmacyReviews() {
  ...
  const distColors = { 5: "bg-green-500", 4: "bg-lime-400", 3: "bg-yellow-400", 2: "bg-orange-400", 1: "bg-red-400" };
      ...
      <div className="pl-[200px]">
        <main className="px-8 py-7 min-h-screen">
          ...
          <div className="flex items-start justify-between mb-7">
            <div>
              <h1 className="text-[26px] font-black text-gray-900 tracking-tight leading-tight">My Reviews</h1>
              <p className="text-gray-400 text-[13px] mt-0.5">Customer feedback for your pharmacy</p>
            </div>
          ...
          {/* Summary cards + rating breakdown */}
          {!loading && (
            <div className="grid grid-cols-3 gap-4 mb-7">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col items-center justify-center text-center">
                <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-2">Average Rating</p>
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm py-24 text-center">
              ...
              <h3 className="text-[15px] font-bold text-gray-700 mb-1">
                {totalCount === 0 ? "No reviews yet" : "No reviews match your filters"}
              </h3>
            ...
            <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-3 mb-2">
                        <div>
                          <p className="text-[14px] font-bold text-gray-800">{review.userId?.name || "Customer"}</p>
                      ...
                      {review.comment ? (
                        ...
                        <p className="text-[12px] text-gray-400 italic">No written comment.</p>
                      )}
              ...
              <p className="text-[12px] text-gray-400 px-1 pt-1">{filtered.length} of {totalCount} reviews shown</p>
            </div>
          )}
        </main>
      </div>
