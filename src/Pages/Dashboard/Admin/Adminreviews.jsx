...
export default function AdminReviews() {
  ...
  const filtered = reviews.filter((r) => {
    ...
    const matchPharmacy =
      filterPharmacy === "all" || r.pharmacyId?._id === filterPharmacy;
        ...
        <main className="px-4 sm:px-6 lg:px-8 py-5 sm:py-7 min-h-screen">
          <div className="flex items-start justify-between mb-5 sm:mb-7">
            <div>
              ...
              <p className="text-gray-400 text-[12px] sm:text-[13px] mt-0.5">
                Customer reviews across all pharmacies
              </p>
            </div>
            <button
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 sm:p-3.5 flex flex-col gap-2.5 mb-5">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search by customer, pharmacy, or comment…"
                value={search}
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <div className="hidden sm:block">
                ...
                <div className="divide-y divide-gray-50">
                  {filtered.map((review) => (
                    <div
                      key={review._id}
                      className="px-5 py-4 grid grid-cols-[1.2fr_1.2fr_0.8fr_1.8fr_100px_40px] gap-3 items-center hover:bg-gray-50/40 transition-colors"
                    >
                      ...
                      <div className="flex items-center gap-2.5 min-w-0">
                        ...
                        <div className="min-w-0">
                          <p className="text-[13px] font-bold text-gray-800 truncate">
                            {review.pharmacyId?.name || "Pharmacy"}
                          </p>
                        </div>
                      </div>
                ...
                {filtered.map((review) => (
                  <div key={review._id} className="px-4 py-4">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      <Stars rating={review.rating} />
                      <span
                        className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${review.rating >= 4 ? "bg-green-50 text-green-700" : review.rating === 3 ? "bg-yellow-50 text-yellow-700" : "bg-red-50 text-red-600"}`}
                      >
                        {review.rating}/5
                      </span>
              ...
              <div className="px-4 sm:px-5 py-3 border-t border-gray-100 bg-gray-50/40 rounded-b-2xl">
                <p className="text-[12px] text-gray-400">
                  {filtered.length} of {totalReviews} reviews shown
                </p>
              </div>
            </div>
          )}
